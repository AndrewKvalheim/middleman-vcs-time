Feature: Git support
  ...
  Scenario: Use the file modification time when the source file is untracked
    ...
    Then I should see the file modification time of "source/show-mtime_untracked.html.erb"
  ...
  Scenario: Use the file modification time when there are working changes to the source file
    ...
    Then I should see the file modification time of "source/show-mtime_working.html.erb"
